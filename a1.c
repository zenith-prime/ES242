 ...
 */
void selecter(int a[], int n, int k, int b[], void *data, void(*process_selection)(int*b, int k, void *data), int x, int y)
{
    if(x==k)
    {
    ...
    {
        b[x]=a[i];
        selecter(a, n, k, b, data, process_selection, x+1, i+1);
    }
}
